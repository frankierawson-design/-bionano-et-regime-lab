...
- [x] Source code separated from manuscript.
- [x] OSI-approved MIT licence.
- [x] Installation and local-run instructions.
- [x] Machine-readable example parameters.
- [x] Automated tests for documented limiting cases.
